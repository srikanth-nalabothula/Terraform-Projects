...
resource "aws_internet_gateway" "DBlock-IGW" {
  vpc_id = aws_vpc.DBlock-Vpc.id
  tags = {
    Name = var.igw_name
  }
}
...
resource "aws_route_table" "terraform-public" {
  ...
  route {
    ...
    gateway_id = aws_internet_gateway.DBlock-IGW.id
  }

  tags = {
    Name = var.DBlock_Routing_Table
  }
}
...
#}
#
#resource "aws_vpc_security_group_ingress_rule" "Inbound-DBlock" {
...
#}
#
#resource "aws_vpc_security_group_egress_rule" "Outbound-DBlock" {
#  security_group_id = aws_security_group.allow_all.id
#
#  cidr_ipv4   = "0.0.0.0/0"
#  from_port   = 0
